...
class Functions{
    ...
    public function getIndex($template, $replace = ['from' => [], 'to' => []]){
        ...
        if($this->isLogged()){
            ...
            $replace['to'][] = '
            <div class="logout2 block">
              <div class="profile" style="background: url('.$_SESSION['avatarfull'].') no-repeat center center; background-size: cover;">
<a href="/user">
                <div class="top_bar">
                <div class="name">
                    '.$_SESSION['name'].'
                  ...
                  <form action="/steam?logout">
                                    <input type="button" OnClick="/steam?logout" value=" ">
                  </form>
                  </a>
                  </a>
                </div>
        ...
        ';
            ...
            <div class="login2 block">
              <a href="/steam?login" target="blank">
                <div class="top_s">
