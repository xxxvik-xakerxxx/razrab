...
if ($_SESSION['auth_admin'] == 'yes_auth') {
    ...
    $_SESSION['urlpage'] = "<a href='index.php'>Главная</a> / <a href='cases.php'>Кейсы</a> / <a>Изменение кейсов</a> ";
    ...
    if ($_POST['submit_save']) {
            ...
            if (!empty($error)) {
                ...
                $_SESSION['message'] = '<p id="form-success">Кейс успешно изменен!</p>';
   ...
   <form  enctype="multipart/form-data" method="POST">
									...
									if ($row[red_stock] == 1)$checked2 = "checked";
										echo'   												
														<div class="form-group">
															<ul id="checkbox">
															<input class="checkbox" type="checkbox" name="chk_visible" id="chk_visible" '.$checked1.'/><label for="chk_visible">Включить/Выключить кейс</label>
															</ul>
														</div>
														<div class="form-group">
															<ul id="checkbox">
															<input class="checkbox" type="checkbox" name="chk_stock" id="chk_stock" '.$checked2.'/><label for="chk_stock">Включить/Выключить запрет на красное</label>
															</ul>
														</div>
													</div>
												</div>
                                                    ...
                                                    <div class="row">
                                                       <div class="form-group">
                                                        <label for="inputMessage" class="control-label">
                                                            Предметы через запятую</label><textarea rows="5" class="form-control" name="form_items">'.$row['items'].'</textarea></div> 
                                                       </div> 
                                                </div>
                                                <div class="form-actions text-right pal">
                                                     <input id="submit_form" type="submit" name="submit_save" class="btn btn-primary" value="Сохранить изменения"/>
                                                </div>
                                                </form>
                                            </div>
                                        </div>
