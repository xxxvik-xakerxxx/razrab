...
if ($_SESSION['auth_admin'] == 'yes_auth') {
    ...
    $_SESSION['urlpage'] = "<a href='http://nickbi71.pserver.ru/'>Сайт</a> / <a href='index.php'>Главная</a> / <a href='faq.php'>FAQ</a> / <a>Добавление вопроса</a> ";
    require_once ('connector.php');
    if ($_POST['submit_add']) {
            if (!empty($error)) {
                $_SESSION['message'] = '<p id="form-error">'.implode('<br />', $error).'</p>';
            } else {
                    mysql_query("INSERT INTO faq(title,decrition)
		VALUES (
		'".$_POST["form_title"]."',
		'".$_POST["form_description"]."'
		)",$bd);
             }
         $_SESSION['message'] = '<p id="form-success">Вопрос успешно добавлен!</p>';
    }
    ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="add_faq.php"><i class="fa fa-edit fa-fw">
                        <div class="icon-bg bg-violet"></div>
                                                    ...
                                                    <div class="row">
                                                       <div class="form-group">
                                                        <label for="inputMessage" class="control-label">
                                                           Ответ на вопрос</label><textarea rows="5" class="form-control" name="form_description"></textarea></div> 
                                                       </div> 
                                                </div>
                                                <div class="form-actions text-right pal">
                                                     <input id="submit_form" type="submit" name="submit_add" class="btn btn-primary" value="Добавить вопрос"/>
                                                </div>
                                                </form>
                                            </div>
                                        </div>
