...
$_SESSION['urlpage'] = "<a href='/'>Сайт</a>  /  <a>Административная панель </a>";
...
<body>
                ...
                <ul id="side-menu" class="nav">
					...
					<li ><a href="itemserror.php"><i class="fa fa-bomb fa-fw">
                        <div class="icon-bg bg-violet"></div>
										...
										<li ><a href="sentOffers.php"><i class="fa fa-check-square-o fa-fw">
																	<div class="icon-bg bg-violet"></div>
															</i><span class="menu-title">Oтправленные предметы</span></a>
 ...
 <?php
  ...
  $sum3=mysql_query("SELECT SUM(amount) FROM payments WHERE status = '1'",$bd);
                ...
                <div class="page-content">
                            ...
                            <div class="panel-body">
                                <table class="table table-hover">
                                    <thead>
                                    <tr>
                                        <th><center>Название кейсa</center></th>
...
?>
                            ...
                            <div class="panel-body">
                                <table class="table table-hover">
                                    <thead>
                                    <tr>
                                        <th><center>Стим аккаунт</center></th>
