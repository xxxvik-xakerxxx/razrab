...
if ($_SESSION['auth_admin'] == 'yes_auth') {
    ...
    $_SESSION['urlpage'] = "<a href='index.php'>Главная</a> / <a href='faq.php'>FAQ</a> / <a>Изменение FAQ</a> ";
    ...
    if ($_POST['submit_save']) {
            if (!empty($error)) {
                ...
                $_SESSION['message'] = '<p id="form-success">FAQ успешно изменен!</p>';
                                                    ...
                                                    <div class="row">
                                                       <div class="form-group">
                                                        <label for="inputMessage" class="control-label">
                                                            Ответ на вопрос</label><textarea rows="5" class="form-control" name="form_decrition">'.$row['decrition'].'</textarea></div> 
                                                       </div> 
                                                </div>
