...
$_SESSION['urlpage'] = "<a href='/'>Сайт</a> / <a href='index.php'>Главная</a> / <a>FAQ</a>";
...
?>
<span class="h2class"><button type="button" class="btn btn-success" onclick="javascript:window.location='add_faq.php'">Добавить вопрос</button> <span class="badge bg-theme"><b><?php echo $all_count_rez; ?></b></span>
...
echo '
                                    ...
                                    <div class="col-lg-6">
                                        <div class="note note-success"><h4 class="box-heading">'.$row["title"].'</h4>
                                           ...
                                           <a  role="button" class="btn btn-primary" href="edit_faq.php?id='.$row["id"].'">Изменить</a> <a role="button" class="btn btn-danger" href="faq.php?'.$url.'id='.$row['id'].'&action=delete" class="delete">Удалить</a> 
                                    </div>
                           ';
