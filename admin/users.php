...
$_SESSION['urlpage'] = "<a href='http://Ez-wINCSGO.RU/'>Сайт</a> / <a href='index.php'>Главная</a> / <a>Пользователи</a>";
...
<html lang="en">
<head>
    <title>Пользователи | Административная панель</title>
    <meta charset="utf-8">
...
<tbody align="center">
																				<tr>																								<td>'.$row['steamid'].'</td>
																							    ...
																							    <td>'.$row['status'].'</td><td><span class="tooltip-area">
																									<a  role="button" class="btn btn-primary" href="edit_users.php?id='.$row["steamid"].'">Изменить</a>  <a role="button" class="btn btn-danger" href="users.php?'.$url.'id='.$row['steamid'].'&action=delete" class="delete">Удалить</a>
																									</span>
</td></tr>
