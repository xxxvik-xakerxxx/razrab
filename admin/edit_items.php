...
if ($_SESSION['auth_admin'] == 'yes_auth') {
    ...
    $_SESSION['urlpage'] = "<a href='index.php'>Главная</a> / <a href='items.php'>Предметы</a> / <a>Изменение предметов</a> ";
    include ('connector.php');
    $id = $_GET["id"];
   
    
    if ($_POST['submit_save']) {
            	$querynew = "weapon='{$_POST["form_weapon"]}',name='{$_POST["form_name"]}',image='{$_POST["form_image"]}',type='{$_POST["form_type"]}'";
            	$update = mysql_query("UPDATE items SET $querynew WHERE id='$id'",$bd);
                $_SESSION['message'] = '<p id="form-success">Успешно изменили предмет!</p>';
...
<?php
$all_count = mysql_query("SELECT * FROM items",$bd);
...
?>
            ...
            ?>
<?php
$result = mysql_query("SELECT * FROM items WHERE id='$id'",$bd);
...
<input type="text" class="form-control" name="form_weapon" value="'.$row['weapon'].'">
</div></div>
<div class="form-group">
<label>Наименование</label>
<div class="input-icon right">
<i class="fa fa-fire"></i>
<input type="text" class="form-control" name="form_name" value="'.$row['name'].'">
</div></div>
<div class="form-group">
<label>Картинка</label>
<div class="input-icon right">
<i class="fa fa-picture-o "></i>
<input type="text" class="form-control" name="form_image" value="'.$row['image'].'">
</div></div>
<div class="form-group">
<label>Тип</label>
<div class="input-icon right">
<i class="fa fa-cog"></i>
<input type="text" class="form-control" name="form_type" value="'.$row['type'].'">
</div></div>
            
<br><br>
                <p align="right"><input id="submit_form" type="submit" name="submit_save" class="btn btn-primary" value="Сохранить изменения"/></p>
