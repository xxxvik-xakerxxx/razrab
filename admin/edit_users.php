...
if ($_SESSION['auth_admin'] == 'yes_auth') {
    ...
    $_SESSION['urlpage'] = "<a href='index.php'>Главная</a> / <a href='user.php'>Пользователи</a> / <a>Изменение пользователя</a> ";
    ...
    if ($_POST['submit_save']) {
                ...
                $_SESSION['message'] = '<p id="form-success">Успешно изменили профиль!</p>';
