...
if ($_SESSION['auth_admin'] == 'yes_auth') {
    ...
    $_SESSION['urlpage'] = "<a href='index.php'>Главная</a> / <a>Настройки сайта</a> ";
    include ('connector.php');
    $id = $_GET["id"];
   
    
    if ($_POST['submit_save']) {
            	$querynew = "title_index='{$_POST["title_index"]}',decr_index='{$_POST["decr_index"]}'";
            	$update = mysql_query("UPDATE main_drop SET $querynew",$bd);
...
<?php
$result = mysql_query("SELECT * FROM `main_drop` ",$bd);
...
<input type="text" class="form-control" name="title_index" value="'.$row['title_index'].'">
</div></div>
<div class="form-group">
<label>Наименование</label>
<div class="input-icon right">
<i class="fa fa-fire"></i>
<input type="text" class="form-control" name="decr_index" value="'.$row['decr_index'].'">
</div></div>
