...
if ($_SESSION['auth_admin'] == 'yes_auth') {
    ...
    $_SESSION['urlpage'] = "<a href='http://nickbi71.pserver.ru/'>Сайт</a> / <a href='index.php'>Главная</a> / <a href='cases.php'>Кейсы</a> / <a>Добавление кейсов</a> ";
    ...
    if ($_POST['submit_add']) {
		...
		'".$_POST["form_lim"]."'
                ...
                $_SESSION['message'] = '<p id="form-success">Кейс успешно добавлен!</p>';
                $id = mysql_insert_id();
   ...
   <form  enctype="multipart/form-data" method="POST">
                                                <div class="form-body pal">
                                                    ...
                                                    <div class="form-group">
													 ...
													 <div class="form-group">
                                                        <label for="casePrice" class="control-label">
                                                           Колличество открытых кейсов</label>
                                                        <div class="input-icon right">
                                                            <i class="fa fa-credit-card"></i>
													...
													<div class="col-md-6">													
														<div class="form-group">
															<ul id="checkbox">
															<input class="checkbox" type="checkbox" name="chk_visible" id="chk_visible" /><label for="chk_visible">Включить/Выключить кейс</label>
															</ul>
														</div>
													</div>
													</div>
                                                    ...
                                                    <div class="row">
                                                       <div class="form-group">
                                                        <label for="inputMessage" class="control-label">
                                                            Предметы через запятую</label><textarea rows="5" class="form-control" name="form_items"></textarea></div> 
                                                       </div> 
                                                </div>
